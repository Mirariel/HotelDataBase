...
namespace DataBase.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeesId,FirstName,LastName,Position,Birthday,Phone,Email,HireDate,ResidencePlace,Education,Salary")] Employee employee)
        {
